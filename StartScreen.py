...
background_image = pyglet.image.load('Background.jpg')  # Replace with your image file path
background_sprite = pyglet.sprite.Sprite(background_image)

# Create a label for the welcome message
welcome_label = pyglet.text.Label(
    'Welcome to Monster Slumber Party',
    font_name='Arial',
    font_size=32,
    x=window_width // 2,
    y=window_height - 200,
...
subtitle = pyglet.text.Label(
    'Press Space to start, remember to stay quiet',
    font_name='Arial',
    font_size=16,
    x=window_width // 2,
    y=window_height - 300,
